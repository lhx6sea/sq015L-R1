...
#define TestIO                	(PORTB2)

#define _pLED_1D               	(PORTB1)		//1档
#define _pLED_2D_3D             (PORTB0)		//2档,3档

#define Fan_1D                  (PORTB2)		//高
#define Fan_2D                  (PORTB4)		//'0'
#define Fan_3D                  (PORTB5)		//'0'
...
#define LED_1D()             	{_pLED_1D=0; _pLED_2D_3D=1;}
#define LED_2D_3D()            	{_pLED_1D=1; _pLED_2D_3D=0;}
#define LED_close()            	{_pLED_1D=1; _pLED_2D_3D=1;}

#define FanSpeed0()             {Fan_1D=0;Fan_2D=1;Fan_3D=1;ODCON=0X30;} 	//关机开漏
#define FanSpeed1()             {Fan_1D=1;Fan_2D=1;Fan_3D=1;ODCON=0X30;}	//一档开漏
#define FanSpeed2()             {Fan_1D=1;Fan_2D=0;Fan_3D=1;ODCON=0X20;}
#define FanSpeed3()             {Fan_1D=1;Fan_2D=0;Fan_3D=0;ODCON=0X00;}
